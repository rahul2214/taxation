...
const testimonials = [
  { name: "Jane Doe", role: "Freelancer", text: "Polaris Tax Services made my tax season stress-free. The platform is intuitive and their experts were incredibly helpful!", avatar: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&q=80&w=100&h=100", fallback: "JD" },
  { name: "John Smith", role: "Small Business Owner", text: "I've been using Polaris Tax Services for my business for three years now. Impeccable service and they always find deductions I missed.", avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&q=80&w=100&h=100", fallback: "JS" },
  { name: "Emily White", role: "Investor", text: "Complex investments are no problem for the Polaris Tax Services team. Highly recommend for anyone with a complicated tax situation.", avatar: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?auto=format&fit=crop&q=80&w=100&h=100", fallback: "EW" },
];
